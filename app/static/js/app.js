...
const NewsList = Vue.component('news-list', {
  ...
  <div>
      ...
      <div class="form-group mx-sm-3 mb-2" id="searchContainer">
          <label class="sr-only" for="search">Search</label>
          <input type="search" name="search" v-model="searchTerm"
          id="search" class="form-control mb-2 mr-sm-2" placeholder="Enter search term here" />
          <p id="searchmessage">You are searching for {{ searchTerm }}</p>
      </div>
      
      <button id="searchbtn" class="btn btn-primary mb-2" @click="searchNews">Search</button>
